...
%% sample flows
[Flows,Effect_sizes,Cov_settings] = Flow_Sampler(Graphs,parameters);
...
function [Flows,Effect_sizes,Cov_settings] = Flow_Sampler(Graphs,parameters)
            ...
            for j = 1:n_rhos
                ...
                for l = 1:n_averaging_params
                    ...
                    if E < edge_max
                        ...
                        %% estimate effect size (compute on subgraph)
